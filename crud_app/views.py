    ...
    if request.method == 'POST':
        ...
        if password == password_confirm:
            ...
            try:
                ...
                return render(request, 'register.html', {'error': 'Username already taken or invalid.'})
        else:
            return render(request, 'register.html', {'error': 'Passwords do not match.'})
    return render(request, 'register.html')

# List all items (require login)
@login_required
...
# Edit an existing item (require login)
@login_required
